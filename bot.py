...
async def restrict_text_messages(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # ပုံမှန် User များ စာရိုက်လာပါက တုံ့ပြန်မှု မလုပ်ဘဲ လျစ်လျူရှုထားမည်
    return
...
async def handle_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "start_tarot":
        ...
        if user_id != config.CREATOR_ID:
            if USER_USAGE_LOG.get(user_id) == today_str:
                # အနီရောင် Bold Text ဖြင့် ပြသခြင်း
    ...
    # ၂။ ကတ်ကို လှန်လိုက်သည့် အဆင့်
        ...
        # ဟောပြောချက် အပြည့်အစုံကို ပြင်ဆင်ခြင်း (စာလုံးရေ ၃၀၀ အထိ မျှတအောင်ညှိထားသော ဒေတာများကို ဖတ်မည်)
        full_interpretation = (
            f"🃏 <b>{card_name}</b>\n\n"
            f"❤️ <b>အချစ်ရေး</b>\n{reading_data['love']}\n\n"
        ...
        # Loading text နေရာတွင် ဟောပြောချက်စာသားများဖြင့် အစားထိုးလဲလှယ်ခြင်း
...
def main():
    ...
    # Background Thread အနေဖြင့် Dummy Web Server အား တပြိုင်နက် Run ပေးခြင်း (Port Scan Error ကျော်ရန်)
